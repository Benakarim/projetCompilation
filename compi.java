...
/*********************************************************************************************************************/
	...
	public String UL_reserve(String chaine) {
		...
		String[] Affichage = {"mot reserve pour guillemets",
				...
				"Mot reserve pour afficher un message ","mot reserv� pour l'affichage de valeur de variable ", "carectere reserve pour un commentaire","carectere reserve", "Mot reserve Fin du programme" };
		int i = 0;
				...
				if(word[i].equals("Int_Number")){
					...
					if(word[i].equals(" "))i++;
						...
						if(num(word[i]) == "Nombre entier") {
							i++;
							if(word[i].equals(";;")) return "affectation dune valeur entiere a une  variable  ";
						}
						else if(num(word[i]) == "Nombre reel"){
							i++;
							if(word[i].equals(";;")) return "affectation dune valeur reel a�une variable  ";
						}
			...
			int i=0;
				...
				if(word[i].equals("Int_Number")){
					...
					if(num(word[i]) == "Nombre entier") {
							i++;
                                                        if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "Affectation de la valeur entiere  "+word[i-1]+"  � la variable  "+word[i-3];
						}
						else if(num(word[i]) == "Nombre reel"){
							i++;
                                                        if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "Affectation de la valeur re�l : "+word[i-1]+" � la variable : "+word[i-3];
						}
					...
					if(word[i].equals(" "))i++;
                                        ...
                                        if(word[i].equals(" "))i++;
						if(id(word[i]) != null)i++;
							if(word[i].equals(";;")) return " c'est une d�claration d'une variable reel"+word[i-1];
						}
					...
					if(word[i].equals("to")){
						...
						if(id(word[i]) != null) {
							i++;
							if(word[i].equals(";;")) return "Affectation de la variable "+word[i-3]+" � "+word[i-1];
						}
					...
					i++;
						...
						if(id(word[i]) != null)i++;
                                                if(word[i].equals("\""))i++;
                                                  if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "affichage du la chaine de carectere : "+word[i-2];
						}
					...
					i++;
						...
						if(id(word[i]) != null)i++;
                                                  ...
                                                  if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "affichage du la valeur de "+word[i-2];
						}
